...
# Función que valida un dato, y si es correcto, lo coloca en captura, si no, se mantiene preguntando. 
# Los argumentos que acepta una función, simplemente se enumeran entre los paréntesis.
